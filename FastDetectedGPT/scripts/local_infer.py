...
if __name__ == '__main__':
    ...
    parser.add_argument('--reference_model_name', type=str, default="gpt-2")  # gpt-neo-2.7B / use gpt-j-6B for more accurate detection
    parser.add_argument('--scoring_model_name', type=str, default="gpt-2")
